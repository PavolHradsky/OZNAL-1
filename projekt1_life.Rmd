...
# onfussion matrix
confusionMatrix(as.factor(predicted_class), as.factor(actual), positive = "1")
...
# library(randomForest)
# # Model
# rf_model <- randomForest(status_oh ~ train_data_rf$`Life expectancy` + train_data_rf$`Adult # Mortality` + train_data_rf$Alcohol  +
#               train_data_rf$`percentage expenditure` + train_data_rf$BMI + 
#               train_data_rf$`Total expenditure` + train_data_rf$Diphtheria + # train_data_rf$`HIV/AIDS` + train_data_rf$GDP +
#               train_data_rf$`Income composition of resources` + train_data_rf$Schooling, data = # train_data_rf)
# summary(rf_model)
# # Predictions
# rf_predictions <- predict(rf_model, test_data)
# 
