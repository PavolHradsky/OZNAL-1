...
---
# Regresia bola odstránená z dôvodu prehľadnosti.
...
Vybrali sme len stĺpce, ktoré najviac korelujú a to **GDP** a **percentage expenditure**, ktoré sa budeme snažiť **predikovať** vzhľadom na status rozvinutosti krajiny. 
...
tuning_grid <- expand.grid(sigma = seq(0.1, 1, by = 0.1),
                           C = 2^(-2:2))
#model
