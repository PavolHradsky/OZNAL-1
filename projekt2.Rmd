...
tuning_grid <- expand.grid(sigma = seq(0.1, 1, by = 0.3), C = 2^(-1:1))
...
## experiment s kategorickou verziou predikovanej hodnoty
...
# Calculate performance metrics
data.frame(
  Model = c("SVM-linear","SVM-radial", "Random Forest", "LDA"),
  Accuracy = c(
