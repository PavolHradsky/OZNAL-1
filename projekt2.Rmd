...
K-fold cross validácia aplikovaná na klasifikáciu, kde **response** variable bude **"status_oh"** a ostatné stĺpce **(GDP, Schooling)** budú **prediktory**. Použitý naive bayes model. 
...
# hyperparameter tuning for SVM radial kernel , predictors GDP and percentage expenditure
